...
#
            ...
            explain_enabled=params.get("explain_enabled", True),
            collect_graph_data=params.get("collect_graph_data", True),
            collect_chart_replay=params.get("collect_chart_replay", True),
            graph_sample_ticks=params.get("graph_sample_ticks", 1),
